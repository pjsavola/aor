...
public class InstitutionalResearchTest {
    ...
    public static void main(String[] args) {
        ...
        final TestServer server = Test.initializeTestWithAdvances(clients, 1, 94, 0, false);
        ...
        client.addResponse(new PurchaseAdvancesResponse(List.of(Advance.institutionalResearch, Advance.caravan)), false);
        client.addResponse(new PurchaseAdvancesResponse(List.of(Advance.institutionalResearch)), true);
        client.addResponse(new BooleanResponse(false), true); // stab
        client.addResponse(new IntegerResponse(0), true); // bid
        client.addResponse(new CommodityResponse(null), true); // shortage/surplus adjust
        client.addResponse(new IntegerResponse(-1), true); // card play
        client.addResponse(new BooleanResponse(false), true); // ships
        client.addResponse(new PurchaseAdvancesResponse(List.of(Advance.proselytism)), false);
        client.addResponse(new PurchaseAdvancesResponse(List.of(Advance.urbanAscendancy, Advance.nationalism, Advance.caravan)), false);
        client.addResponse(new PurchaseAdvancesResponse(List.of(Advance.urbanAscendancy, Advance.writtenRecord)), true);
